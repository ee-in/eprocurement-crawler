...
CREATE TABLE `organization_info` (
  `pk_atm_main` varchar(100) NOT NULL COMMENT '採購網主鍵',
  `tender_case_no` varchar(100) NOT NULL COMMENT '標案案號',
  `org_id` varchar(100) DEFAULT NULL COMMENT '機關代碼',
  `org_name` varchar(100) DEFAULT NULL COMMENT '機關名稱',
  `unit_name` varchar(50) DEFAULT NULL COMMENT '單位名稱',
  `org_address` varchar(200) DEFAULT NULL COMMENT '機關地址',
  `contact` varchar(100) DEFAULT NULL COMMENT '聯絡人',
  `tel` varchar(100) DEFAULT NULL COMMENT '聯絡電話',
...
CREATE TABLE `procurement_info` (
  `pk_atm_main` varchar(100) NOT NULL COMMENT '採購網主鍵',
  `tender_case_no` varchar(100) NOT NULL COMMENT '標案案號',
  `procurement_type` varchar(200) DEFAULT NULL COMMENT '招標方式',
  `awarding_type` varchar(100) DEFAULT NULL COMMENT '決標方式',
  `is_follow_law_64_2` char(1) DEFAULT NULL COMMENT '是否依政府採購法施行細則第64條之2辦理',
  `num_transmit` varchar(100) DEFAULT NULL COMMENT '新增公告傳輸次數',
  `revision_sn` varchar(10) DEFAULT NULL COMMENT '公告更正序號',
  `is_follow_law_106_1_1` char(1) DEFAULT NULL COMMENT '是否依據採購法第106條第1項第1款辦理',
  `subject_of_procurement` varchar(200) DEFAULT NULL COMMENT '標案名稱',
  `attr_of_awarding` varchar(100) DEFAULT NULL COMMENT '決標資料類別',
  ...
  `attr_of_procurement` varchar(200) DEFAULT NULL COMMENT '標的分類',
  ...
  `procurement_money_amt_lv` varchar(100) DEFAULT NULL COMMENT '採購金額級距',
  `conduct_procurement` varchar(200) DEFAULT NULL COMMENT '辦理方式',
  `is_gpa` varchar(100) DEFAULT NULL COMMENT '是否適用WTO政府採購協定(GPA)：',
  `is_anztec` varchar(100) DEFAULT NULL COMMENT '是否適用臺紐經濟合作協定(ANZTEC)：',
  `is_astep` varchar(100) DEFAULT NULL COMMENT '是否適用臺星經濟夥伴協定(ASTEP)：',
  `restricted_tendering_law` varchar(1000) DEFAULT NULL COMMENT '限制性招標依據之法條',
  ...
  `fulfill_location` varchar(400) DEFAULT NULL COMMENT '履約地點',
  `fulfill_location_district` varchar(1000) DEFAULT NULL COMMENT '履約地點（含地區）',
  `is_special_budget` char(1) DEFAULT NULL COMMENT '是否含特別預算',
  `project_type` varchar(100) DEFAULT NULL COMMENT '歸屬計畫類別',
...
CREATE TABLE `tender_info` (
  ...
  `tenderer_id` varchar(100) DEFAULT NULL COMMENT '廠商代碼',
  `tenderer_name` varchar(400) DEFAULT NULL COMMENT '廠商名稱',
  `tenderer_name_eng` varchar(400) DEFAULT NULL COMMENT '廠商名稱(英)',
  `is_awarded` char(1) DEFAULT NULL COMMENT '是否得標',
  `organization_type` varchar(100) DEFAULT NULL COMMENT '組織型態',
  `industry_type` varchar(100) DEFAULT NULL COMMENT '廠商業別',
  `address` varchar(1000) DEFAULT NULL COMMENT '廠商地址',
  `address_eng` varchar(1000) DEFAULT NULL COMMENT '廠商地址(英)',
  `tel` varchar(100) DEFAULT NULL COMMENT '廠商電話',
  `award_price` decimal(10,0) DEFAULT NULL COMMENT '決標金額',
  `country` varchar(100) DEFAULT NULL COMMENT '得標廠商國別',
...
CREATE TABLE `tender_award_item` (
  ...
  `awarded_tenderer` varchar(200) DEFAULT NULL COMMENT '得標廠商',
  `request_number` int(11) DEFAULT NULL COMMENT '預估需求數量',
  `award_price` decimal(10,0) DEFAULT NULL COMMENT '決標金額',
  `base_price` decimal(10,0) DEFAULT NULL COMMENT '底價金額',
  `source_country` varchar(200) DEFAULT NULL COMMENT '原產地國別',
...
CREATE TABLE `award_info` (
  ...
  `no_price_dynamic_description` varchar(200) DEFAULT NULL COMMENT '未列物價調整規定說明',
  `fulfill_execution_org_id` varchar(100) DEFAULT NULL COMMENT '履約執行機關代碼',
  `fulfill_execution_org_name` varchar(200) DEFAULT NULL COMMENT '履約執行機關名稱',
...
CREATE TABLE `tender_declaration_info` (
  /* 機關資料 */
  `primary_key` varchar(100) NOT NULL COMMENT '採購網主鍵',
  `org_id` varchar(100) DEFAULT NULL COMMENT '機關代碼',
  `org_name` varchar(100) DEFAULT NULL COMMENT '機關名稱',
  `unit_name` varchar(50) DEFAULT NULL COMMENT '單位名稱',
  `org_address` varchar(200) DEFAULT NULL COMMENT '機關地址',
  ...
  `tel` varchar(100) DEFAULT NULL COMMENT '聯絡電話',
  `fax` varchar(100) DEFAULT NULL COMMENT '傳真號碼',
  `email` varchar(200) DEFAULT NULL COMMENT '電子郵件信箱',
  /* 採購資料 */
  `tender_case_no` varchar(100) NOT NULL COMMENT '標案案號',
  `subject_of_procurement` varchar(200) DEFAULT NULL COMMENT '標案名稱',
  `attr_of_procurement` varchar(200) DEFAULT NULL COMMENT '標的分類',
  `project_no` varchar(200) DEFAULT NULL COMMENT '工程計畫編號',
  `is_construction` char(1) DEFAULT NULL COMMENT '本採購案是否屬於建築工程',
  `attr_of_goods` varchar(100) DEFAULT NULL COMMENT '財物採購性質',
  `procurement_money_amt_lv` varchar(100) DEFAULT NULL COMMENT '採購金額級距',
  `conduct_procurement` varchar(200) DEFAULT NULL COMMENT '辦理方式',
  `apply_law` varchar(200) DEFAULT NULL COMMENT '依據法條',
  `is_gpa` varchar(100) DEFAULT NULL COMMENT '是否適用WTO政府採購協定(GPA)：',
  `is_anztec` varchar(100) DEFAULT NULL COMMENT '是否適用臺紐經濟合作協定(ANZTEC)：',
  `is_astep` varchar(100) DEFAULT NULL COMMENT '是否適用臺星經濟夥伴協定(ASTEP)：',
  `budget_amount` decimal(10,0) DEFAULT NULL COMMENT '預算金額',
  ...
  `num_transmit` varchar(100) DEFAULT NULL COMMENT '新增公告傳輸次數',
  `procurement_status` varchar(100) DEFAULT NULL COMMENT '招標狀態',
