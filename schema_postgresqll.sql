...
CREATE TABLE organization_info (
  pk_atm_main varchar(100) NOT NULL,
  tender_case_no varchar(100) NOT NULL,
...
CREATE TABLE procurement_info (
  pk_atm_main varchar(100) NOT NULL,
  tender_case_no varchar(100) NOT NULL,
  procurement_type varchar(200) DEFAULT NULL,
  awarding_type varchar(100) DEFAULT NULL,
  is_follow_law_64_2 char(1) DEFAULT NULL,
  num_transmit varchar(100) DEFAULT NULL,
  revision_sn varchar(10) DEFAULT NULL,
  is_follow_law_106_1_1 char(1) DEFAULT NULL,
  subject_of_procurement varchar(200) DEFAULT NULL,
  attr_of_awarding varchar(100) DEFAULT NULL,
  ...
  attr_of_procurement varchar(200) DEFAULT NULL,
  ...
  procurement_money_amt_lv varchar(100) DEFAULT NULL,
  conduct_procurement varchar(200) DEFAULT NULL,
  is_gpa varchar(100) DEFAULT NULL,
  is_anztec varchar(100) DEFAULT NULL,
  is_astep varchar(100) DEFAULT NULL,
  restricted_tendering_law varchar(1000) DEFAULT NULL,
  is_budget_amount_public char(1) DEFAULT NULL,
  budget_amount decimal(10,0) DEFAULT NULL,
  is_org_subsidy char(1) DEFAULT NULL,
  fulfill_location varchar(400) DEFAULT NULL,
  fulfill_location_district varchar(1000) DEFAULT NULL,
...
CREATE TABLE tender_info (
  ...
  tenderer_id varchar(100) DEFAULT NULL,
  tenderer_name varchar(400) DEFAULT NULL,
  tenderer_name_eng varchar(400) DEFAULT NULL,
...
CREATE TABLE tender_award_item (
  ...
  awarded_tenderer varchar(200) DEFAULT NULL,
...
CREATE TABLE award_info (
  ...
  no_price_dynamic_description varchar(200) DEFAULT NULL,
  fulfill_execution_org_id varchar(100) DEFAULT NULL,
  fulfill_execution_org_name varchar(200) DEFAULT NULL,
...
CREATE TABLE tender_declaration_info (
  ...
  subject_of_procurement varchar(200) DEFAULT NULL,
  attr_of_procurement varchar(200) DEFAULT NULL,
  project_no varchar(200) DEFAULT NULL,
  is_construction char(1) DEFAULT NULL,
  attr_of_goods varchar(100) DEFAULT NULL,
  procurement_money_amt_lv varchar(100) DEFAULT NULL,
  conduct_procurement varchar(200) DEFAULT NULL,
  apply_law varchar(200) DEFAULT NULL,
  is_gpa varchar(100) DEFAULT NULL,
  is_anztec varchar(100) DEFAULT NULL,
  is_astep varchar(100) DEFAULT NULL,
  budget_amount decimal(10,0) DEFAULT NULL,
  ...
  num_transmit varchar(100) DEFAULT NULL,
  procurement_status varchar(100) DEFAULT NULL,
  ...
  award_address varchar(100) DEFAULT NULL,
  is_tender_bond char(1) DEFAULT NULL,
  submit_language varchar(100) DEFAULT NULL,
  submit_address varchar(1000) DEFAULT NULL,
  --其他
  is_follow_law_99 char(1) DEFAULT NULL,
  fulfill_location varchar(400) DEFAULT NULL,
  fulfill_deadline varchar(200) DEFAULT NULL,
  is_post_bulletin char(1) DEFAULT NULL,
  is_authorities_template char(1) DEFAULT NULL,
  project_type varchar(100) DEFAULT NULL,
